...
def run_ml_app():
    ...
    COAplicant_income = left.number_input("coApplicant_Income")
...
def predict(gender, married, dependent, education, self_employed, applicant_income, coApplicant_income
    ...
    [[gen, mar, dependent, edu, sem, appplicant_income, coApplicant_income, loan_amount, loan_amount_term,
    credit_history, pro]]
    )

    result = "Not Eligible" if predict == 0 else "Eligible"
    return result
